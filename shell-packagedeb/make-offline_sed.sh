...
for i in `seq 1 15`; do sudo dpkg-scanpackages /offline/major /dev/null | gzip > /offline/major/Packages.gz & done
...
# 指定路径，注意要相同
deb [trusted=yes] file:/// offline/pre/
deb [trusted=yes] file:/// offline/major/
